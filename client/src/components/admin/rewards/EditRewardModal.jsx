...
const EditRewardModal = ({ reward, onClose, onSubmit }) => {
    const [form, setForm] = useState({});

    useEffect(() => {
        if (reward) {
            setForm({
                studentName: reward.studentName || reward.student?.name || "",
                studentId: reward.studentId || reward.student?._id || "",
                rewardName:
                    reward.rewardName || reward.title || reward.reward?.name || "",
                rewardType: reward.rewardType || reward.type || "other",
                grade: reward.grade || reward.class || "",
                ...
                testName: reward.testName || reward.test?.name || "",
                testId: reward.testId || reward.test?._id || "",
                description:
