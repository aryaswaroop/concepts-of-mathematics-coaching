...
const CourseEmptyState = ({ hasFilters, onAddCourse }) => {
    return (
        <div className="px-5 py-14 text-center sm:px-8">
            ...
            <p className="mx-auto mt-2 max-w-md text-sm leading-6 text-slate-500">
                {hasFilters
                    ? "Try changing your search or filters to find the course you are looking for."
                    : "Create the first course to start managing academic programs from this workspace."}
            </p>
