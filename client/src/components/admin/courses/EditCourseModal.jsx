...
const EditCourseModal = ({ course, onClose }) => {
    ...
    const handleSubmit = (event) => {
        ...
        /*
         * Backend update API will be connected later.
         */
                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="mt-0.5 text-xs text-slate-400">
                                        Update academic course details
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="space-y-4 px-5 py-5 sm:px-6">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        required
                                        className="h-10 w-full rounded-xl border border-slate-200 bg-white px-3 text-sm text-slate-700 outline-none transition focus:border-blue-300 focus:ring-4 focus:ring-blue-50"
                                    />
                                </div>
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        onChange={handleChange}
                                        rows={4}
                                        className="w-full resize-none rounded-xl border border-slate-200 bg-white px-3 py-2.5 text-sm leading-6 text-slate-700 outline-none transition focus:border-blue-300 focus:ring-4 focus:ring-blue-50"
                                    />
                                </div>
                                ...
                                <div className="rounded-xl border border-amber-100 bg-amber-50/60 px-3.5 py-3">
                                    <p className="text-xs leading-5 text-amber-700">
                                        Changes will be synchronized with
