                ...
                <div className="rounded-2xl border border-slate-200/80 bg-white/85 p-4 shadow-[0_10px_30px_rgba(15,23,42,0.03)]">
                    <div className="flex flex-col gap-3 xl:flex-row xl:items-center">
                        ...
                        <select
                            ...
                            className="h-10 min-w-[135px] rounded-xl border border-slate-200 bg-white px-3 text-sm font-medium text-slate-600 outline-none transition focus:border-blue-300 focus:ring-4 focus:ring-blue-50"
                        >
                    ...
                    <div className="mt-3 flex items-center gap-2 border-t border-slate-100 pt-3">
                        ...
                        <p className="text-[11px] font-medium text-slate-400">
                            Batch timings and capacity are managed according
                            to the coaching schedule.
                        </p>
                    </div>
                </div>
            </div>
