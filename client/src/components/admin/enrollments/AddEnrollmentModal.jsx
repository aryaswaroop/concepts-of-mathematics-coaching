...
const AddEnrollmentModal = ({ isOpen, onClose, onSubmit }) => {
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="mt-0.5 text-xs text-slate-400">
                                Create a student enrollment record
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="grid gap-5 p-5 sm:grid-cols-2">
                        ...
                        <div className="sm:col-span-2">
                            ...
                            <input
                                ...
                                className="w-full rounded-xl border border-slate-200 bg-white px-3.5 py-2.5 text-sm outline-none transition placeholder:text-slate-300 focus:border-blue-400 focus:ring-4 focus:ring-blue-50"
                            />
                        </div>
