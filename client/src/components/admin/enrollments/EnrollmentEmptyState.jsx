    ...
    return (
        <div className="px-5 py-14 text-center sm:px-8">
            ...
            <p className="mx-auto mt-2 max-w-md text-sm leading-6 text-slate-500">
                {hasFilters
                    ? "Try changing your search or filters to find the enrollment you are looking for."
                    : "Create an enrollment to connect a student with the appropriate course and batch."}
            </p>
