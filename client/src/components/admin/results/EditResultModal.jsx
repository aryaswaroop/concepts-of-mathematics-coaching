...
const EditResultModal = ({
    ...
    const [form, setForm] =
        useState(getInitialForm(result));
            ...
            >
                <div className="flex items-center justify-between border-b border-slate-100 px-5 py-4 sm:px-6">
                    ...
                    <button
                        ...
                        aria-label="Close edit result modal"
                    >
                        <X className="h-4 w-4" />
                    </button>
                </div>
                ...
                >
                    ...
                    <div className="flex flex-col-reverse gap-2 border-t border-slate-100 bg-slate-50/60 px-5 py-4 sm:flex-row sm:justify-end sm:px-6">
                        ...
                        <button
                            type="submit"
                            className="h-10 rounded-xl bg-slate-950 px-5 text-xs font-bold text-white hover:bg-blue-600"
                        >
                            Save changes
                        </button>
                    </div>
