            ...
            <div className="relative z-10 mx-auto grid min-h-[620px] max-w-[1280px] items-center gap-12 px-4 py-20 sm:px-6 lg:grid-cols-[1.05fr_0.95fr] lg:px-7 lg:py-24">
                ...
                >
                    ...
                    <p className="mt-6 max-w-xl text-base leading-7 text-slate-600 sm:text-lg">
                        Regular tests help students understand where they
                        stand, identify areas for improvement and build
                ...
                >
                    <div className="relative mx-auto max-w-[520px]">
                        ...
                        <div className="relative overflow-hidden rounded-[2rem] border border-slate-200/80 bg-white/80 p-5 shadow-[0_25px_80px_rgba(15,23,42,0.10)] backdrop-blur-xl sm:p-7">
                            ...
                            <div className="space-y-3 py-6">
                                {[
                                    ["01", "Weekly Test", "Evaluate understanding"],
                                    ["02", "Result", "Understand performance"],
                                    ["03", "Ranking", "Track position"],
                                    ["04", "Improve", "Focus on weak areas"],
